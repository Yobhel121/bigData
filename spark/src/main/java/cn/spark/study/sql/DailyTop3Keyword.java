...
public class DailyTop3Keyword {
    ...
    public static void main(String[] args) {
        ...
        Dataset<Row> dailyTop3KeywordDF = sqlContext.sql(""
        ...
        Dataset<Row> finalDF = sqlContext.createDataFrame(sortedRowRDD, structType);

        finalDF.write().format("hive").mode(SaveMode.Append).saveAsTable("daily_top3_keyword_uv");
